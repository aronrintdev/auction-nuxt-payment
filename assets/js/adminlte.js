...
(function (global, factory) {
  ...
  const ControlSidebar = /* #__PURE__ */function () {
    ...
    _proto.collapse = function collapse() {
      ...
      const target = this._config.target; // Show the control sidebar
  ...
  const SELECTOR_TAB_NAV = SELECTOR_DATA_TOGGLE$1 + '.iframe-mode .nav';
  const SELECTOR_TAB_NAVBAR_NAV = SELECTOR_DATA_TOGGLE$1 + '.iframe-mode .navbar-nav';
  ...
  const SELECTOR_TAB_CONTENT = SELECTOR_DATA_TOGGLE$1 + '.iframe-mode .tab-content';
  ...
  const IFrame = /* #__PURE__ */function () {
    ...
    _proto._setupListeners = function _setupListeners() {
      ...
      $__default.default(document).on('mousedown', SELECTOR_DATA_TOGGLE_SCROLL_LEFT, function (e) {
        ...
        let scrollOffset = _this2._config.scrollOffset;
