<template>
  <div class="d-flex justify-content-between flex-wrap pr-4">
    <div v-for="(trade) in tradesList" :key="'trade-' + trade.id" role="button" class="trade-listing-item-single mt-3">
      ...
      <div class="d-flex justify-content-between p-4" @click="showTrade(trade.id)">
        <div class="d-block">
          ...
          <div class="listed-time">{{$t('trades.listed_on')}} {{ trade.created_at | formatDateTimeString }}</div>
        </div>
