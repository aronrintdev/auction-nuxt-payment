<template>
  <div>
    ...
    <b-container fluid>
      <div
        class="main-image-section d-flex align-items-center justify-content-center w-100"
      >
        <div class="br-20 shadow product-error-box">
          <div
