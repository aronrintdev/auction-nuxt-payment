export const RISKIFIED_DOMAIN = 'https://beacon.riskified.com';
export const PUSHER = {
  APP_ID: '1475055',
  APP_KEY: 'ad7ca53e8ecde66a6112',
  cluster: 'us2'
}
...
export const TRANSACTION_FEE_PERCENT = 10;
export const WS_HOST = 'localhost'
export const CONTACTNUMBER = '(213) 788-4442';
export const HELP_MAIL = 'help@deadstock.co';
