  ...
  <div v-if="options && options.length" class="accordion-filter-item bg-transparent border-0 w-100">
    <h2 id="panelsStayOpen-headingOne" class="accordion-filter-header mb-0">
      <button
        ...
        aria-expanded="false"
        class="accordion-filter-button collapsed position-relative w-100 d-flex align-items-center border-0 bg-none p-0"
      ...
      <div class="accordion-filter-body p-0 d-flex justify-content-between">
        <b-form-group class="start-date h-100">
          <b-input-group @click="showStartDate">
            <b-form-input
              type="date"
              class="date-input bg-white rounded-circle py-3"
        ...
        <b-form-group class="start-date h-100">
          <b-input-group @click="showEndDate">
            <b-form-input
              type="date"
              class="date-input bg-white rounded-circle"
