    ...
    <div class="filter-container">
      <div class="d-flex mt-2 ml-2">
        ...
        <div @click="closeFilter()">
          <img  class="cross-image" :src="require('~/assets/img/trades/cross.svg')"/>
        </div>
      </div>
      <div class="mt-1 ml-2">
      ...
      <div class="mt-1 ml-2">
        <div class="d-flex" v-b-toggle="'collapse-1'">
          ...
          <div class="d-flex">
            ...
            <img  v-if="isVisible" class="arrow-image pull-right" :src="require('~/assets/img/trades/upArrow.svg')"/>
            <img  v-else class="arrow-image pull-right" :src="require('~/assets/img/trades/downArrow.svg')"/>
          </div>
        </div>
      ...
      <div class="mt-1 ml-2">
        <div class="d-flex" v-b-toggle="'collapse-sizeType'">
          ...
          <div class="d-flex">
            ...
            <img  v-if="isVisibleSizeType" class="arrow-image pull-right" :src="require('~/assets/img/trades/upArrow.svg')"/>
            <img  v-else class="arrow-image pull-right" :src="require('~/assets/img/trades/downArrow.svg')"/>
          </div>
        </div>
      ...
      <div class="mt-1 ml-2">
        <div class="d-flex" v-b-toggle="'collapse-sizes'">
          ...
          <div class="d-flex">
            <!--          <span class="selected-catgory pull-left">{{sizeTypesFilter}}</span>-->
            <img  v-if="isVisibleSizes" class="arrow-image pull-right" :src="require('~/assets/img/trades/upArrow.svg')"/>
            <img  v-else class="arrow-image pull-right" :src="require('~/assets/img/trades/downArrow.svg')"/>
          </div>
        </div>
