<template>
  <b-row class="mx-5 ">
    ...
    <b-col md="9" class="pt-5 d-flex flex-column justify-content-center">
      <b-row class="mb-2 d-block body-4-normal">
        <div class="body-4-bold mb-2 text-gray-24">{{ $t('bids.product_details') }}</div>
        <b-row>
          <b-col sm="4">
            <div class="mb-2">{{ auctionItem.inventory.product.name }}</div>
          </b-col>
          <b-col>{{
...
/**
 * Component which shows single item from auction which type is single
 * @name BidAuctionSummarySingle
 */
export default {
  name: 'BidAuctionSummarySingle',
  ...
  props: {
    /**
     * Single auction item from auction_items
     */
    auctionItem: {
      type: Object,
      required: true
