...
export const convertToUnderscoreCase = (str, divider = ' ', join = '_') => {
    return str.toLowerCase().split(divider).join(join)
}
 ...
 * @returns {string}
 */
export const tradeRemainingTime = (createdAt, timeLimit) => {
