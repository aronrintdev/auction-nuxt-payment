<template>
  ...
  <b-col md="3">
    <OrderTitle
      class="text-danger"
      :title="$t('shopping_cart.error')"
    />

    <!-- Shopping Cart Order Error Text -->
    <b-row class="mt-4">
      <b-col md="10">
        <div class="body-5-regular">{{ $t('shopping_cart.payment_method_card_error') }}</div>
      </b-col> </b-row
    ...
    <b-row class="mt-4 mb-2">
      <b-col md="12">
        <div class="body-4-medium">{{ $t('shopping_cart.billing_address') }}&colon;</div>
      </b-col>
    </b-row>
    <AddressCard
      editable
    ...
    <b-row v-if="paymentMethod" class="mt-4 mb-2">
      <b-col md="12">
        <div class="body-4-medium">{{ $t('shopping_cart.payment') }}&colon;</div>
      </b-col>
    </b-row>
