...
(function ($) {
  ...
  $('.main-header')[0].classList.forEach(function (className) {
    if (navbar_all_colors.includes(className) && active_navbar_color === null) {
  ...
  $('body')[0].classList.forEach(function (className) {
    if (accent_colors.includes(className) && active_accent_color === null) {
  ...
  $('.main-sidebar')[0].classList.forEach(function (className) {
    ...
    if (sidebar_colors.includes(color) && active_sidebar_dark_color === null) {
  ...
  $('.main-sidebar')[0].classList.forEach(function (className) {
    ...
    if (sidebar_colors.includes(color) && active_sidebar_light_color === null) {
  ...
  $('.brand-link')[0].classList.forEach(function (className) {
    if (logo_skins.includes(className) && active_brand_color === null) {
